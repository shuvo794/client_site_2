...
const ProductDetails = () => {
  ...
  useEffect(() => {
    const url = `https://client-project.onrender.com/products/${id}`;
    fetch(url)
      .then((res) => res.json())
  ...
  const onSubmit = (data) => {
    ...
    fetch("https://client-project.onrender.com/addOrders", {
      method: "POST",
    ...
    <>
      <div className="container detail-order">
        <div className="row">
              ...
              <div class="row g-0">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <p class="card-text fs-3 text-secondary fw-bold">
                      $ {singleProduct?.price}
                    </p>
                  </div>
                </div>
          ...
          <div
            data-aos="fade-left"
            className="col-lg-6 col-md-12 col-12 product-form"
          >
